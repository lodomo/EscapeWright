...
import { control_panel_kana } from "./svg_raw.ts";
...
setInnerHTML("#kana", control_panel_kana);
...
<div class="message-container">
  ...
  <button data-target="status" class="message-btn no">No</button>
</div>
`);
...
setInnerHTML("#nav_override", `<img src="/images/override.png" alt="Overrides" />`);
...
function navButtonHandler(event: MouseEvent) {
    setActiveDiv(event, NAV_BUTTONS, NAV_PANELS);
}
